class Misc_Content:
	...
	def DarkSouls(self):
		...
		<p> (once again this is a draft, and I'll come back and write more later, I need more pages for testing) In Conclusion, the dark souls series is my favorite game series ever. </p>
		"""
